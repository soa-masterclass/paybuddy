 ...
 * 
 */
@WebServiceClient(name = "BankWebService", targetNamespace = "http://ws.samplebank.masterclass.soa.cgi.com/", wsdlLocation = "file:/C:/paybuddy/paybuddy/src/main/resources/META-INF/BankWebService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/paybuddy/paybuddy/src/main/resources/META-INF/BankWebService.wsdl");
